        ...
        <div class="mb-3">
            ...
            <div id="variants">
                ...
                <div class="row variant-group mb-2">
                    <div class="col-md-3">
                        <input name="variants[<?= $i ?>][size]" class="form-control" value="<?= $v['size'] ?>" required>
                    </div>
                    <div class="col-md-3">
                        <input name="variants[<?= $i ?>][color]" class="form-control" value="<?= $v['color'] ?>" required>
                    </div>
                    <div class="col-md-4">
                        <input name="variants[<?= $i ?>][sku]" class="form-control" value="<?= $v['sku'] ?>" required>
                    </div>
                    <div class="col-md-2 d-grid">
                        <button type="button" class="btn btn-danger" onclick="this.parentElement.parentElement.remove()">🗑️</button>
                    </div>
